 ...
 <div class="contanier text-center encabezado">
  ...
  <div class="card registro text-center" style="margin-top: 60px; width: 75%; position: absolute; top: 50%; left: 45%; transform: translate(-50%, -50%);">
    <div class="card-header reg">
      <h3>Modificación de Docentes</h3>
    </div>
...
<form action="modiDocente.php" method="post">    
  ...
  <div class="row f1">
    <div class="col">No. Usuario
      <input type="text" id="numeroControl" class="form-control" aria-label="No.Control">
    </div>
  ...
  <div class="row f1">
    ...
    <div class="col">Correo
      <input type="text" id="correo" class="form-control"  aria-label="Correo">
    </div>
    <div class="col">Contraseña
      <input type="password" id="password" class="form-control" name="password"  aria-label="Contraseña">
    </div>
    <div class="col">Num.Cel
      <input type="text" id="telefono" class="form-control"  aria-label="Cel">
    </div>
  ...
  <div class="botoncitos">
      ...
      <input class="button btn btn-primary btn-sm botoncito2" style="background-color: rgb(87, 15, 15);" type="button" name="eliminar" value="Eliminar" onclick="confirmDelete()" /> </div>
  </div>
</form>
  <script>
$(document).ready(function() {
    $('#busqueda').autocomplete({
        source: 'buscar_docente.php',
        select: function(event, ui) {
            $.ajax({
                url: 'datos_docente.php',
...
<script>
    function confirmDelete() {
        var confirmation = prompt("Por favor, escribe 'Confirmar' para eliminar al docente.");
