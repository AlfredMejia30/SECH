...
<body >
 ...
 <div class="contanier text-center encabezado">
  ...
  <div class="botoncitos">
    <button type="button" class="btn btn-primary btn-sm botoncito2"> <a class="nav-link" href="regDocente.php">DOCENTES</a></button>
    <button type="button" class="btn btn-primary btn-sm botoncito2 "> <a class="nav-link" href="regAlumno.php">ALUMNOS</a></button>
    </div>
</div>
